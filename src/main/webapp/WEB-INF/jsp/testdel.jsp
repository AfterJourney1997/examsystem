...
<table>
    ...
    <tr valign="top">
        ...
        <td align="center">
            ...
            <table border="1">
                <tr>
                 <td>试卷编号</td><td>试卷名称</td><td>详情</td><td>操作</td>
                </tr>
                <c:forEach var="alltest" items="${listAllTest}">
                    <tr>
                        <td>${alltest.testId}</td>
                        <td>${alltest.testName}</td>
                        <td><a href="/examsystem/looktest?testId=${alltest.testId}">点击查看试卷</a></td>
                        <td><a href="/examsystem/deltest?testId=${alltest.testId}">删除</a></td>
                    </tr>
                </c:forEach>
            </table>
